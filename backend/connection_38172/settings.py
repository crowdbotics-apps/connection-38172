"""
Django settings for connection_38172 project.
...
ROOT_URLCONF = 'connection_38172.urls'
...
WSGI_APPLICATION = 'connection_38172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connection_38172 API",
    "DESCRIPTION": "API documentation for connection_38172 App",
    "VERSION": "v1",
}
